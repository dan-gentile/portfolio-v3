          ...
          >
            <article className="touring">
              ...
              <p>
                ...
                pixel mapping and cueing as necessary. Traveled with the show
                for the entire record cycle including headlining and festival
                shows across the globe. In addition to content playback the
                server handled various live inputs. Sometimes these feeds were
                clean straight to the screens. Other times the feeds were fed
                through various Notch realtime fxs before heading to the
                screens. During the show the server control was split between
                the lighting console using SockPuppet and MIDI control.
              </p>
              <h5>Links</h5>
              <ul>
                <li>
